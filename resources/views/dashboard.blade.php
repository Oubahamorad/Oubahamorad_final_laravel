...
@section('content')
    ...
    <div class="mt-3 space-y-1">
        <nav class="navbar bg-black">
            ...
            <div class="container-fluid flex">
                <a class="navbar-brand text-success text-white mx-5" href="{{ url('/dashboard') }}">L’BLA<span
                        class=" text-yellow-300">SSA.</span></a>
    ...
    <div class="relative bg-gradient-to-r from-purple-900 to-indigo-800 py-16 font-[sans-serif]">
        <div class="absolute inset-0">
            <img src="{{ asset('image/Web_150DPI-191017_20_Level28_View_2771.avif') }}" alt="Background Image"
        ...
        <div class="relative max-w-screen-xl mx-auto px-8 z-10 text-center text-white">
            ...
            <button type="button"
                class="   bg-yellow-200 hover:bg-yellow-500 text-white text-base font-semibold px-8 py-2.5 rounded-full transition duration-300 ease-in-out shadow-lg hover:shadow-xl ">
                <a class="text-white decoration-transparent" href="{{ route('reserve.index') }}">Reserve</a></button>
        </div>
    </div>
    {{-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! --}}
        ...
        <div class="max-w-6xl mx-auto py-16 px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-md:max-w-md mx-auto">
                <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                    <div class="p-6">
                      <svg xmlns="http://www.w3.org/2000/svg" height="20" class="my-2" width="25" viewBox="0 0 640 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M54.2 202.9C123.2 136.7 216.8 96 320 96s196.8 40.7 265.8 106.9c12.8 12.2 33 11.8 45.2-.9s11.8-33-.9-45.2C549.7 79.5 440.4 32 320 32S90.3 79.5 9.8 156.7C-2.9 169-3.3 189.2 8.9 202s32.5 13.2 45.2 .9zM320 256c56.8 0 108.6 21.1 148.2 56c13.3 11.7 33.5 10.4 45.2-2.8s10.4-33.5-2.8-45.2C459.8 219.2 393 192 320 192s-139.8 27.2-190.5 72c-13.3 11.7-14.5 31.9-2.8 45.2s31.9 14.5 45.2 2.8c39.5-34.9 91.3-56 148.2-56zm64 160a64 64 0 1 0 -128 0 64 64 0 1 0 128 0z"/></svg>
                        <h3 class="text-xl font-semibold mb-2">Fast internet</h3>
                        <p class="text-gray-500 text-sm">refers to high-speed internet connections that provide rapid data transfer rates. This allows users to quickly access and download digital content, stream high-definition videos without buffering, participate in online gaming with minimal lag, and conduct video calls smoothly. Fast internet enables efficient web browsing, faster file downloads and uploads, and seamless online experiences across various devices. It's essential for modern digital activities, from entertainment and communication to work and education..</p>
                    </div>
                </div>
                <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                    <div class="p-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 mb-4"
                        ...
                        <p class="text-gray-500 text-sm">Security is a critical aspect of modern digital operations, ensuring the safety and integrity of systems, networks, and data. It encompasses a range of practices and technologies aimed at protecting against unauthorized access, data breaches, cyberattacks, and other security threats.</p>
                    </div>
                </div>
                <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                    <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm opacity-75">L’BLASSA is not only a coworking space in Casablanca.
                            ...
                            it is above all a lab for creative entrepreneurs, creators & startups to innovate, connect &
                            build a network beyond the standards of corporate life.

                            Located in Gueliz, Coworking L’BLASSA in casablanca has reimagined the ideal environment for its
                            members to achieve their full potential and professional goals.</p>
                        <a href="javascript:void(0);" class="mt-4 inline-block text-blue-200 text-sm hover:underline">
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm opacity-75">Our unique offering goes beyond the traditional coworking model to
                            include a fully equipped cafeteria. We know that great ideas are often born over a cup of coffee
                            or a refreshing drink.</p>
                        <a href="javascript:void(0);" class="mt-4 inline-block text-pink-200 text-sm hover:underline">
                            <button type="button" class="btn btn-outline-warning mx-5 m-2" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">
                                Découvrir
                            </button>
                ...
                <div
                    ...
                    <div class="p-6">
                        <h3 class="text-2xl font-semibold mb-2">Salles de réunion / formation<< /h3>
                                <p class="text-sm opacity-75">Cowork in casablanca at L’BLASSA, nestled in the lively
                                    Gueliz district, here you’ll find your perfect blend of modern convenience and
                                    professional atmosphere. This space is more than just a coworking space; it’s a hub
                                    where freelancers, digital nomads and professionals meet to transform their work
                                    experience. Designed with your productivity in mind, L’BLASSA offers a range of
                                    facilities from soundproof phone booths for quiet calls to a sophisticated meeting room
                                    ideal for brainstorming and collaboration. Convenience continues with accessible
                                    printing services, while our on-site cafeteria and serene terrace provide the perfect
                                    setting for work breaks and informal networking.</p>
                                <a href="javascript:void(0);"
                                    class="mt-4 inline-block text-green-200 text-sm hover:underline"> <button
                                        type="button" class="btn btn-outline-warning mx-5 m-2" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal">
                                        Découvrir
                                    </button>
                                </a>
                ...
                @foreach ($admins as $admin)
                    <div
                        class="bg-gradient-to-b from-indigo-800 to-indigo-600 text-white rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
                        <img src="{{ asset('storage/image/' . $admin->image) }}" alt="Blog Post 1"
                            class="w-full h-64 object-cover" />
                        <div class="p-6">
                    ...
                    <div class="col-md-8">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="card">
                                    <div class="img-wrapper"><img
                                            src="https://codingyaar.com/wp-content/uploads/headshot-1-scaled.jpg"
                                            class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                                        <h5 class="card-title">Aouzal Soumia</h5>
                                        <div class="flex m-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="10" width="11.25"
                                        ...
                                        <p class="card-text">Voilà un excellent espace de co-working au cœur de Marrakech !
                                            Très bien équipé, très bien entretenu et avec un personnel aux petits soins !
                                            J'ai réservé le box insonorisé pour 2h à raison de 50 dirhams par heure (un peu
                                            moins de 5€). Le WiFi y est de très bonne qualité (2h de visio non stop avec le
                                            bout du monde et aucune coupure ou faiblesse du signal).
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">It was such a relief finding this place after trying to work
                                            remotely from terrible airbnb wifi. Its got a cute cafe as well and 3 phone
                                            booths for meetings (its a quiet space so no meetings in shared spaces) i had
                                            all day meetings and didn't have an issue finding a free booth. Super friendly
                                            staff, lots of desks/plugs and zero issues with wifi (several networks). Would
                                            10/10 recommend if you need a reliable place to get work done!</p>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img
                                            src="https://codingyaar.com/wp-content/uploads/headshot-3-scaled.jpg"
                                            class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Ein toller Platz zum Arbeiten im Herzen von Guilez, der einem
                                            von dem freundlichen & hilfsbereiten Team vom L'Blassa noch angenehmer gemacht
                                            wird.
                                            Das Internet ist schnell & stabil, es gibt Noise-Cancellation-Kabinen zum
                                            Telefonieren und Arbeitsplätze zur freien Wahl auf der Fläche.
                                            Wir fanden das Preis-Leistungsverhältnis absolut fair. Auch das Angebot Kaffee,
                                            Getränke & Snacks vor Ort ist super...
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img
                                            src="https://codingyaar.com/wp-content/uploads/headshot-4-scaled.jpg"
                                            class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Très honnêtement, je n y vais pas pour travailler mais pour
                                            savourer leur délicieux cappuccino au lait de soja. Meilleur café de Marrakech .
                                            Très bon service , endroit propre et très agréable. Je recommande fortement.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img
                                            src="https://codingyaar.com/wp-content/uploads/headshot-5-scaled.jpg"
                                            class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img
                                            src="https://codingyaar.com/wp-content/uploads/headshot-6-scaled.jpg"
                                            class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Merci pour le bon service et bon relation client, tout est
                                            super parfait, je recommande cette très belle place .</p>
                                    </div>
                                </div>
                            </div>
                        </div>
