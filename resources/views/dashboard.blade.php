...
@section('content')
    ...
    <div class="flex gap-10 container justify-around items-center">
         ...
         {{-- @foreach ($admins as $admin)
          <div>   <h4>{{ $admin->name }}</h4>
        <img src="{{ asset("storage/image/" . $admin->image) }}" width="100%" class="h-80" alt="">
       </div>   
        @endforeach 
...
<h3>Un bureau privé et professionnel, accessible à la demande. Parfait quand vous avez besoin de vous concentrer pour travailler au mieux.</h3>
<div class="flex">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-10">
...
<a href="{{ route('reserve.index') }}"><button type="button" class="btn btn-outline-warning"> OBTENIR UN DEVIS </button></a> 
</div>
</div>
</div>
</div>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="flex m-5  gap-2 justify-between ">
        ...
        <p class=" w-100 container m-5 h-100 ">Vous cherchez un espace où travailler vous et votre équipe à Casablanca ?
