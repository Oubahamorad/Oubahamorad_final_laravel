...
<button id="click"  type="button" class="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#exampleModal">
    {{-- Launch demo modal --}}
</button>
            ...
            <div class="modal-body ">
                <form method="post" class="w-full  flex flex-col gap-y-5 " action="/reserve/store">
                    ...
                    <form action="/session" method="get">
                        @csrf
                        <button class="w-f py-3 bg-yellow-300 text-white">pay</button>
                       </form>
                </form>
